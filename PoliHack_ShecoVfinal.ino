...
const int optionButton1 = 5;
const int optionButton2 = 6;
const int optionButton3 = 7;
String selectedMode;
...
int virtualButton1 = 8;
int virtualButton2 = 9;
int virtualButton3 = 10;
int virtualVariable1;
int virtualVariable2;
int virtualVariable3;
int X;
int Y;
float TIME = 0;
float FREQUENCY = 0;
...
void setup() {
  ...
  pinMode(virtualButton1, INPUT);
  pinMode(virtualButton2, INPUT);
  pinMode(virtualButton3, INPUT);
  lcd.init();
...
void loop() {
  ...
  virtualVariable1 = digitalRead(virtualButton1);
  virtualVariable2 = digitalRead(virtualButton2);
  virtualVariable3 = digitalRead(virtualButton3);  
  // if (getDistance() <= 5) {
...
bool checkIfButtonWasPressed() {
  ...
  if (digitalRead(optionButton1) == HIGH || digitalRead(virtualButton1) == HIGH) {
    selectedMode = "Relax Mode";
    selectedModeIndex = 1;
    pressureSwitch.write(0);
    return true;
  } else if (digitalRead(optionButton2) == HIGH || digitalRead(virtualButton2) == HIGH) {
    selectedMode = "Eco Mode";
    selectedModeIndex = 2;
    pressureSwitch.write(70);
    return true;
  } else if (digitalRead(optionButton3) == HIGH || digitalRead(virtualButton3) == HIGH) {
